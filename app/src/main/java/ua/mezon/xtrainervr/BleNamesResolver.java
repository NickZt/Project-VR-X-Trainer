...
public class BleNamesResolver {
    ...
    static {
        ...
        mServices.put("1a8f6007-a27e-4355-8557-db16a7c92fe0", "VRTren CONTROL");

        mServices.put("63a21f41-5c56-4677-b276-6d84e42b8fd7", "VR Trainer Sensors Service");

        mServices.put("6ecc9e4c-9848-4e30-a1e1-c5cf99fba9a9", "VR Trainer Accel X");
        mServices.put("e379c733-1a49-48c7-ac61-cb27976e4c09", "VR Trainer Accel Y");
        mServices.put("e379c733-1a49-48c7-ac62-cb27976e4c09", "VR Trainer Accel Z");
        mServices.put("e805c592-b0a7-405e-ac83-e2bf56efac07", "VR Trainer Param");
        ...
        mCharacteristics.put("00002a2a-0000-1000-8000-00805f9b34fb", "IEEE 11073-20601 Regulatory " +
        ...
        mCharacteristics.put("00002a04-0000-1000-8000-00805f9b34fb", "Peripheral Preferred Connection " +
                "Parameters");
        ...
        // https://developer.bluetooth.org/gatt/characteristics/Pages/CharacteristicViewer.aspx?u=org
