...
//                }
        ...
        public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int
            ...
            String serviceName = BleNamesResolver.resolveServiceName(characteristic.getService().getUuid()
                    .toString().toLowerCase(Locale.getDefault()));
            String charName = BleNamesResolver.resolveCharacteristicName(characteristic.getUuid().toString()
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                mUiCallback.uiFailedWrite(mBluetoothGatt, mBluetoothDevice, mBluetoothSelectedService,
                        characteristic, description + " STATUS = " + status);
            }
        }
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt,
            ...
            mUiCallback.uiGotNotification(mBluetoothGatt, mBluetoothDevice, mBluetoothSelectedService,
                    characteristic);
        }
    ...
    public void startScanning() {
        ...
        SimpleLog.d("TODEL startScanning() runned");
    }
    ...
    public void getCharacteristicValue(BluetoothGattCharacteristic ch) {
        ...
        if (uuid.equals(BleDefinedUUIDs.Characteristic.HEART_RATE_MEASUREMENT)) { // heart rate
            // follow https://developer.bluetooth.org/gatt/characteristics/Pages/CharacteristicViewer
            // .aspx?u=org.bluetooth.characteristic.heart_rate_measurement.xml
            // first check format used by the device - it is specified in bit 0 and tells us if we should ask
            // for index 1 (and uint8) or index 2 (and uint16)
        ...
        } else if (uuid.equals(BleDefinedUUIDs.Characteristic.HEART_RATE_MEASUREMENT) || // manufacturer name
                // string
                uuid.equals(BleDefinedUUIDs.Characteristic.MODEL_NUMBER_STRING) || // model number string)
                uuid.equals(BleDefinedUUIDs.Characteristic.FIRMWARE_REVISION_STRING)) // firmware revision
            // string
        {
            // follow https://developer.bluetooth.org/gatt/characteristics/Pages/CharacteristicViewer
            // .aspx?u=org.bluetooth.characteristic.manufacturer_name_string.xml etc.
            ...
            // follow: https://developer.bluetooth.org/gatt/characteristics/Pages/CharacteristicViewer
            // .aspx?u=org.bluetooth.characteristic.gap.appearance.xml
            ...
            // follow: https://developer.bluetooth.org/gatt/characteristics/Pages/CharacteristicViewer
            // .aspx?u=org.bluetooth.characteristic.body_sensor_location.xml
            intValue = rawValue[0];
            ...
            // follow: https://developer.bluetooth.org/gatt/characteristics/Pages/CharacteristicViewer
            // .aspx?u=org.bluetooth.characteristic.battery_level.xml
            intValue = rawValue[0];
    ...
    public void setNotificationForCharacteristic(BluetoothGattCharacteristic ch, boolean enabled) {
        ...
        // see: https://developer.bluetooth.org/gatt/descriptors/Pages/DescriptorViewer.aspx?u=org.bluetooth
        // .descriptor.gatt.client_characteristic_configuration.xml
        BluetoothGattDescriptor descriptor = ch.getDescriptor(UUID.fromString
